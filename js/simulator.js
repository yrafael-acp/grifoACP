...
async function cargarSimulacionSemanaActual() {
    ...
    try {
        ...
        proyeccionesDual.DIESEL = {
            cons: Array.isArray(json.data.DIESEL?.cons) ? json.data.DIESEL.cons : [0,0,0,0,0,0,0],
            ing: Array.isArray(json.data.DIESEL?.ing) ? json.data.DIESEL.ing : [0,0,0,0,0,0,0],
            saldoIni: parseFloat(json.data.DIESEL?.apertura) || 0
        };

        proyeccionesDual.GASOHOL = {
            cons: Array.isArray(json.data.GASOHOL?.cons) ? json.data.GASOHOL.cons : [0,0,0,0,0,0,0],
            ing: Array.isArray(json.data.GASOHOL?.ing) ? json.data.GASOHOL.ing : [0,0,0,0,0,0,0],
